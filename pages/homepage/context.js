...
const Context = () => {
  return (
    <>
        ...
        <div className="lg:flex 2xl:w-5/6  ml-auto mr-auto ">
          <div className="pt-12  p-10 flex flex-col gap-4">
            ...
            <div className="font-Lora ">
              ...
              on their ideology and thinking process, which may also include the
              experiences they've had in the past. Since no two occasions can be
              the same, no two views will ever match entirely. It is imperative
              to look beyond our perspective and understand that everyone is
              different (and hence has a distinctive perspective) because only
              then can a society live in peace and harmony. Understanding that
              we're all very different will also make the world a more
              empathetic and better place to live in, I firmly believe so. So
              herewith this theme, we will bring the seen and the unseen world
          ...
          <div className="pt-12 p-10 flex flex-col gap-4 ">
            ...
            <div className="font-Lora">
              ...
              foster new connections. We are focused on proffering a TED stage
              to speakers of varied backgrounds and experiences for
              inspirational and intellectual acceleration. In the spirit of
              ideas worth spreading, TEDx is a program for local, self-organized
      ...
      {/* <div className="mt-10 md:flex items-center  flex-row-reverse md:w-4/5 justify-center ml-auto mr-auto">
                <div className="flex justify-center md:block">
                    <img className="w-48 md:w-auto" src="https://i.ibb.co/dggJCXJ/image.png" />
                </div>
                <div className="p-4 flex flex-col gap-4 ">
                    <div className="text-3xl md:text-4xl text-center  font-Cinzel">
