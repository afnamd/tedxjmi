...
const Footer = () =>{
    return(
        <div class="text-white  ml-auto mr-auto w-11/12 2xl:w-10/12 font-Cinzel pt-10 md:pl-10 md:pr-10 flex flex-col gap-10 bg-black">
            <div class="flex gap-12 md:items-start items-center flex-col md:flex-row md:justify-between">
            <div class="flex flex-col gap-3">
                <div class=" font-bold text-center md:text-left text-xl md:text-2xl">
            ...
            <div class="flex flex-col gap-12">
                <div class="flex flex-col gap-2 ">
                    ...
                    <div class="flex border pl-3 rounded-2xl font-sans justify-between">
                        <input type="text" class="p-4 outline-none bg-black w-full placeholder-gray-700" placeholder="email"/>
            ...
            <div class="font-sans mt-10 mb-5 flex md:border-t text-sm  flex-col md:flex-row items-center md:justify-between justify-center">
            <div>
